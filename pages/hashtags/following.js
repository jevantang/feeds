...
Page({
  ...
  onLoad: async function () {
    this.setData({
      ...
      title: await fresnsConfig('channel_following_hashtags_name'),
    });
  ...
  loadFresnsPageData: async function () {
    ...
    const resultRes = await fresnsApi.user.markList(fresnsAuth.uid, 'follow', 'hashtags', {
      filterType: 'whitelist',
      filterKeys: 'htid,url,name,cover,description,viewCount,likeCount,dislikeCount,followCount,blockCount,postCount,postDigestCount,operations,interaction',
      page: this.data.page,
    });
